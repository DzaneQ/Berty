...
namespace Berty.BoardCards.ConfigData
{
    public class BertkaSerferka : CharacterConfig
    {
        public BertkaSerferka()
        {
            ...
            SetCharacter(CharacterEnum.BertkaSerferka);
        ...
        //    OutdatedFieldBehaviour swapTarget = null;
        //    for (int i = 0; i < AttackRange.Count; i++)
        //    {
        //        int index = (i + 2) % AttackRange.Count;
        //        OutdatedFieldBehaviour targetField = card.GetTargetField(AttackRange[index]);
